...
export const Button = ({
  ...
  return (
    <UnstyledButton
      ...
      theme={theme ?? 'primary'}
      btnClassName={(theme) => {
        const defaultClassName = 'outline-none'
        switch (theme) {
          case 'white': {
          ...
          case 'primary': {
            return clsx(defaultClassName, 'bg-primary-500 text-white hover:bg-primary-400 hover:ring-primary-500/30 focus:bg-primary-400/90 focus:ring-primary-500/30 disabled:bg-primary-500/50 ring-2 focus:ring-2 ring-primary-500 focus:ring-primary-100')
          }
        }
      }}
    />
